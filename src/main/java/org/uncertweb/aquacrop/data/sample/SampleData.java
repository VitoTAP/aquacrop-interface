package org.uncertweb.aquacrop.data.sample;
...
public class SampleData {
	...
	public static Project getProject() {
		...
		CropCharacteristics cropCharacteristics = SampleData.getCropCharacteristics();

		// soil data
		SoilCharacteristics soilCharacteristics = SampleData.getSoilCharacteristics();

		// climate data
		ClimateCharacteristics climateCharacteristics = SampleData.getClimateCharacteristics();

		// set files
		Project project = new Project(climateCharacteristics, cropCharacteristics, soilCharacteristics);
		project.setTitle("A sample project");
	...
	public static ClimateCharacteristics getClimateCharacteristics() {
		Co2Measurements co2Measurements = SampleData.getCo2Measurements();
		EvapotranspirationMeasurements etMeasurements = SampleData.getEvapotranspirationMeasurements();
		RainfallMeasurements rainMeasurements = SampleData.getRainfallMeasurements();
		TemperatureMeasurements temperatureMeasurements = SampleData.getTemperatureMeasurements();
